...
namespace WhileStatement
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void openFileClick(object sender, RoutedEventArgs e)
        {
            ...
            if (file != null)//if the file exisits
            {
        ...
        {
            source.Text = "";
            string line = reader.ReadLine();//priming read
            while (line != null)//tests iteration of the variable
            {
                source.Text += line + '\n';
                line = reader.ReadLine();//updates iteration of variable
            }
            reader.Dispose();
        }
