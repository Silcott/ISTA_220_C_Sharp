...
namespace PrimitiveDataTypes
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void showFloatValue()
        {
            float floatVar;
            floatVar = 0.42F;
            value.Text = floatVar.ToString(); //. is access modifier - Text is a property - takes the number value of floatVar and converts to string and assigns it to the text object
        }
        ...
        private void showBoolValue()
        {
            bool boolVar;
            boolVar = false;
            value.Text = boolVar.ToString(); //takes value in boolVar and converts it to a string - thent he assignment operator assigns it from the right oo the left side to the property names Text of the object named value
        }
    }
}
